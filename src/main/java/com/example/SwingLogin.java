...
public class SwingLogin extends JFrame implements ActionListener {
	...
	public SwingLogin() throws HeadlessException {
		...
		setTitle("Login");
		setResizable(false);
		ImageIcon icon = new ImageIcon(getClass().getResource("/main/resources/icon.jpg"));
		...
		ImageIcon iconLogin = new ImageIcon(getClass().getResource("/main/resources/login.png"));
		...
		ImageIcon iconRegister = new ImageIcon(getClass().getResource("/main/resources/register.png"));
		// set size for iconRegister
		...
		ImageIcon iconExit = new ImageIcon(getClass().getResource("/main/resources/exit.png"));
		...
		ImageIcon iconPrintList = new ImageIcon(getClass().getResource("/main/resources/printlist.png"));
		...
		ImageIcon iconAddUser = new ImageIcon(getClass().getResource("/main/resources/add.png"));
		...
		ImageIcon iconDelUser = new ImageIcon(getClass().getResource("/main/resources/delete.png"));
		...
		ImageIcon iconShowApp = new ImageIcon(getClass().getResource("/main/resources/showapp.png"));
		...
		ImageIcon iconUnlock = new ImageIcon(getClass().getResource("/main/resources/unlock.png"));
		...
		ImageIcon iconLock = new ImageIcon(getClass().getResource("/main/resources/lock.png"));
		...
		ImageIcon iconLogout = new ImageIcon(getClass().getResource("/main/resources/logout.png"));
		...
		ImageIcon iconAbout = new ImageIcon(getClass().getResource("/main/resources/about.png"));
